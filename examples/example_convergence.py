'''
Variable definitions for the convergence study (examples a-e) used to
validate PolyUQ's sampling and propagation against reference solutions.

Extracted from the original convergence_PolyUQ.py HPC batch driver;
this module only contains the example variable definitions, with no
HPC/SLURM dependency.
'''
from polyuq import RandomVariable, MassFunction
